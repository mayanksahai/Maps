...
import * as ChatroomActionCreators from '../../redux/actions/chatroom';


function mapDispatchToProps(dispatch){ return bindActionCreators(ChatroomActionCreators,dispatch)}
console.log("Login actions are:" + ChatroomActionCreators);
...
class ChatUI extends Component {
    ...
    sendMessage = (text) => {
        return this.props.sendMessage(text, this.props.user)
    }
